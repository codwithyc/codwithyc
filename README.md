...
Java와 Spring을 기반으로 AI 서비스의 백엔드와 DevOps를 담당해 왔습니다.  
OCR·LLM 작업을 비동기 파이프라인으로 전환하고, 작업 상태 관리와 실패 재처리를 적용해 안정적인 AI 처리 환경을 구축했습니다.  
AWS 기반 배포·모니터링·장애 대응을 경험했으며, Terraform과 GitHub Actions를 활용해 반복 가능한 배포 환경을 구성하고 있습니다.  
백엔드 개발에 머무르지 않고 요구사항 정의, 데이터·권한 설계, 프론트엔드와 인프라까지 제품 전반의 문제를 해결합니다.  
현재는 Kubernetes와 GitOps를 기반으로 AI Agent의 실행·검증·복구를 연결하는 운영 플랫폼을 구축하고 있습니다.
